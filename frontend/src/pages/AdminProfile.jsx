...
const AdminProfile = () => {
  ...
  const [confirmIDNum, setConfirmIDNum] = useState("");
  ...
  function getProfileInfo() {
    ...
    axiosJSONInst
      .get(
        "/user/getInfo/administrator?username=" +
          user_mail[0] +
          "&email=" +
          user_mail[1]
      )
      .then((res) => {
        ...
        setInfoDisplay(
          ...
          >
            ...
            <p>Administrator ID Number: {res.data.admin_id}</p>
          </div>
        );
      })
      .catch((err) => {
    ...
    axiosJSONInst
      .get(
        "/user/verify/admin?username=" +
          ...
          "&admin_id=" +
          encodeURIComponent(confirmIDNum)
      )
      .then((res) => {
        if (res.status !== 200) {
          setDeleteNotif(
          ...
          <div hidden={!currentlyDeleting}>
            ...
            <div id="inputRow" style={{ margin: "1rem 0rem" }}>
              <input
                ...
                onInput={(e) => setConfirmIDNum(e.target.value)}
              ></input>
            </div>
            <div id="inputRow" style={{ margin: "1rem 0rem" }}>
              <input
